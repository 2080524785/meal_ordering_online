...
public class SMS {
     ...
     */
    final static String ACCESS_KEY_ID = "LTAI5tGMmnnjR5kpjAaz8Pv1";
    /**
     * 你的accessKeySecret,填你自己的 上文配置所得 自行配置
     */
    final static String ACCESS_KEY_SECRET =  "QPgww0lkJ9rAkR5pumji2LaSnmyyNE";
    /**
     * 短信签名-可在短信控制台中找到你自己的短信签名填入
     */
    final static String SIGN_NAME = "清风外卖";
    /**
     * 必填:短信模板-可在短信控制台中找到你自己的短信模板填入
     */
    final static String TEMPLATE_CODE = "SMS_461015636";
    private String code ;
     ...
     * @throws Exception
     */
    public String msgSend(String mobile)throws Exception{
        /*此处可输入你的手机号码进行测试*/
